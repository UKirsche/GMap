   ...
   public class Map : GMapControl
   {
      ...
      protected override void OnPaintOverlays(System.Drawing.Graphics g)
      {
         base.OnPaintOverlays(g);
            ...
            //g.DrawString(string.Format(CultureInfo.InvariantCulture, "{0:0.0}", Zoom) + "zhl, " + MapProvider + ", refresh: " + counter++ + ", load: " + ElapsedMilliseconds + "ms, render: " + delta + "ms", DebugFont, Brushes.Blue, DebugFont.Height, DebugFont.Height + 20);
            g.DrawString("Distanz: " + string.Format(CultureInfo.InvariantCulture, "{0:0.0}", Distance), DebugFont, Brushes.Blue, DebugFont.Height, DebugFont.Height + 20);
